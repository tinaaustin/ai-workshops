...
UnBlooms is a practical framework for educators who want to preserve student thinking in an AI-rich learning environment. It builds on the insight that AI can produce polished work without necessarily producing learning. The goal is to help educators design for visible reasoning, metacognition, critical evaluation, and authentic human judgment.
...
The full UnBlooms workbook includes:

- the complete UnBlooms framework
- the Critical AI Evaluation Scale
- the Metacognitive Decision Tree
- classroom activities and reflection prompts
- AI-constrained and AI-integrated assessment strategies
- discipline-specific examples
- rubrics, implementation guidance, and printable reference materials

## For Faculty Developers and Education Leaders

UnBlooms can support:
...
Created by [Tina Austin](https://github.com/tinaaustin), with related writing at [Tina's Substack](https://tinaaustin.substack.com/).
