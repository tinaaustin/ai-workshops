# Tina's AI Tools for Educators

A small public directory of AI tools created to help educators think more clearly about teaching, learning, assessment, and responsible AI use.

These tools are companion resources. The full UnBlooms framework, workbook exercises, rubrics, classroom activities, and implementation guidance are available in the [UnBlooms book](https://www.amazon.com/dp/B0GKZXXW4G?ref=cm_sw_r_ffobk_cp_ud_dp_M60YZKM1Q9ANH60FGSKJ&ref_=cm_sw_r_ffobk_cp_ud_dp_M60YZKM1Q9ANH60FGSKJ&social_share=cm_sw_r_ffobk_cp_ud_dp_M60YZKM1Q9ANH60FGSKJ&bestFormat=true).

## Featured GPTs

### UnBloom It(TM): Help Educators Think Critically

**Best for:** educators, faculty developers, instructional designers, and academic leaders exploring AI-ready teaching and assessment.

**What it helps with:**

- thinking through AI use in assignments
- asking better questions about student reasoning
- reflecting on whether AI is supporting or replacing learning
- introducing educators to UnBlooms-style thinking
